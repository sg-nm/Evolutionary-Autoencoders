...
if __name__ == '__main__':
    ...
    if args.mode == 'evolution':
        ...
        imgSize = 64
        eval_f = CNNEvaluation(gpu_num=args.gpu_num, dataset='bsds_gray', verbose=True, epoch_num=20, batchsize=16, imgSize=imgSize)
    ...
    # --- Retraining evolved architecture ---
        ...
        temp = CNN_train('bsds_gray', validation=False, verbose=True)
